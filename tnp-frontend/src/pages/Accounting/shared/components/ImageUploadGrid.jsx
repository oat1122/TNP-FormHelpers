        ...
        <Grid container spacing={1}>
          {images.map((img, idx) => {
            ...
            const filename =
              ...
              img?.filename ||
              (typeof img === "string" ? img.split("/").pop() : `image_${idx + 1}`);
            return (
                ...
                >
                  ...
                  >
                    ...
                    {onDelete && (
                      ...
                      >
                        <SecondaryButton size="small" color="error" onClick={() => onDelete(img)}>
                          ลบ
                        </SecondaryButton>
                      </Box>
                    )}
      ...
      {preview && previewMode === "dialog" && (
        <Dialog open onClose={() => setPreview(null)} maxWidth="lg" fullWidth>
          ...
          <DialogActions sx={{ justifyContent: "space-between", px: 2 }}>
            ...
            <Box>
              <Button onClick={() => setPreview(null)} size="small" variant="outlined">
                ปิด
              </Button>
            </Box>
          </DialogActions>
