...
import { useUpdateCostFabricOnceMutation, useGetFabricByPatternIdQuery } from "../../services/tnpApi";
...
function FabricEdit({ fabric }) {
  ...
  const calculatedFabricCost = (((Number(fabricInput.fabric_kg) + Number(fabricInput.collar_kg)) * fabricInput.fabric_price_per_kg) / fabricInput.shirt_per_total);  // Calculate fabric cost
  const fabricCost = isFinite(calculatedFabricCost) ? calculatedFabricCost.toFixed() : 0;   // Result fabric cost
  const calcShirtCost = Number(fabricCost) + Number(fabricInput.sewing_price) + Number(fabricInput.cutting_price)
                        + Number(fabricInput.collar_price) + Number(fabricInput.button_price);   // Calculate shirt cost
        ...
        <Form onSubmit={handleSubmit}>
              ...
              <Row>
                <Col lg="12" className="bg-dark rounded-3">
                  <span className="font-38 text-white">
                    {fabric.fabric_name || ""}
                    <small className="font-24 ms-2">
                      {fabric.fabric_name_tnp || ""}
                    </small>
              ...
              <Row className="pe-lg-4">
                ...
                {shirtCate !== 2 && (
                  <>
                    ...
                    <Col lg="12" className="bg-gray rounded-3 p-1 pb-0 mx-lg-3 mt-2 mt-lg-5 d-lg-none">
                      <Form.Control
                        required
                        type="number"
          ...
          <Row className="mx-2 mx-lg-0">
            ...
            <Col lg="6" className="d-flex justify-content-end mt-4 mt-lg-3 pe-0 pe-lg-5">
              <Button type="submit" variant="danger" className="mx-2 my-2 py-2 py-lg-1 btn-submit col-12 col-lg-3">
                submit
              </Button>
            </Col>
            <Col lg="2"></Col>
