    ...
    try {
        ...
        if (provincesData.master_provinces && provincesData.master_provinces.length > 0) {
            ...
            if (provinceId) {
                ...
                const districtsResponse = await fetch(`${baseUrl}/locations?province_sort_id=${provinceId}`, { headers });
                ...
                if (districtsData.master_district && districtsData.master_district.length > 0) {
                    ...
                    if (districtId) {
                        ...
                        const subdistrictsResponse = await fetch(`${baseUrl}/locations?district_sort_id=${districtId}`, { headers });
                        ...
                        if (subdistrictsData.master_subdistrict && subdistrictsData.master_subdistrict.length > 0) {
