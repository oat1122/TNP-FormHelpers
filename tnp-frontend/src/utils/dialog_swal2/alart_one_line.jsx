...
const errorStyle = {
  ...
  color: "#991B1B",
  border: "none",
  boxShadow: "0 8px 16px rgba(220, 38, 38, 0.2), inset 0 -2px 0 rgba(220, 38, 38, 0.1)",
};
...
const successStyle = {
  ...
  color: "#166534",
  border: "none",
  boxShadow: "0 8px 16px rgba(22, 163, 74, 0.2), inset 0 -2px 0 rgba(22, 163, 74, 0.1)",
};
...
const warningStyle = {
  ...
  color: "#92400E",
  border: "none",
  boxShadow: "0 8px 16px rgba(217, 119, 6, 0.2), inset 0 -2px 0 rgba(217, 119, 6, 0.1)",
};
...
const loadingStyle = {
  ...
  color: "#1E40AF",
  border: "none",
  boxShadow: "0 8px 16px rgba(37, 99, 235, 0.2), inset 0 -2px 0 rgba(37, 99, 235, 0.1)",
};
    ...
    >
      ...
      <div style={{ flex: 1 }}>
        ...
        <div
          className="toast-progress"
          style={{
            background: "linear-gradient(to right, rgba(220, 38, 38, 0.5), rgba(220, 38, 38, 0.7))",
...
export function open_dialog_ok(title, text) {
  ...
  return toast.success(
    <div style={{ display: "flex", alignItems: "flex-start", gap: "12px" }}>
      ...
      <div>
        <div style={{ fontWeight: "600", marginBottom: "4px", fontSize: "15px" }}>{title}</div>
