...
function SewingOrder({ data }) {
  ...
  const SettingRow = () => {
    ...
    const [orderDatePick, setOrderDatePick] = useState(moment(data.sewing_start));
    const [receiveDatePick, setReceiveDatePick] = useState(moment(data.sewing_end));
      ...
      <>
          ...
          >
            <form onSubmit={handleSubmitOrder}>
              <Modal.Header className="py-1">
                <Modal.Title className="mx-auto">Sewing Start Date</Modal.Title>
              </Modal.Header>
              <Modal.Body>
        ...
        <div className="content-setting rounded-end">
          <input
            type="checkbox"
            className="btn-check"
            id={`btn-check-sewing-${data.pd_id}`}
            autoComplete="off"
            name="showTab"
            onChange={handleShow}
          />
          <label
            ...
            htmlFor={`btn-check-sewing-${data.pd_id}`}
          >
