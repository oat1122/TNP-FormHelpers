...
CREATE TABLE `customer_notification_reads` (
  ...
  `is_dismissed` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Whether the notification is dismissed (hidden permanently)',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_customer_user_read` (`cus_id`,`user_id`),
  KEY `idx_user_read_at` (`user_id`,`read_at`) USING BTREE
...
CREATE TABLE `customer_transfer_history` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_cth_action_by` (`action_by_user_id`) USING BTREE,
  KEY `idx_cth_created_at` (`created_at`) USING BTREE,
  KEY `idx_cth_customer_id` (`customer_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `notebook_histories`
--

DROP TABLE IF EXISTS `notebook_histories`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `notebook_histories` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `notebook_histories_notebook_id_index` (`notebook_id`),
  KEY `notebook_histories_action_by_index` (`action_by`)
...
CREATE TABLE `notebooks` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `nb_date` date DEFAULT NULL,
  `nb_time` varchar(255) DEFAULT NULL,
  `nb_customer_name` varchar(255) DEFAULT NULL,
  `nb_is_online` tinyint(1) NOT NULL DEFAULT 0,
  `nb_additional_info` text DEFAULT NULL,
  `nb_contact_number` varchar(255) DEFAULT NULL,
  `nb_email` varchar(255) DEFAULT NULL,
  `nb_contact_person` varchar(255) DEFAULT NULL,
  `nb_action` varchar(255) DEFAULT NULL,
  `nb_status` varchar(255) DEFAULT NULL,
  `nb_remarks` text DEFAULT NULL,
  `nb_manage_by` int(11) DEFAULT NULL COMMENT 'User ID (Sales) who manages this notebook entry',
  `nb_converted_at` timestamp NULL DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=2663 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `production_notes` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`note_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1515 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `users` (
  ...
  `role` enum('admin','manager','production','graphic','sale','technician','account','telesale') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
-- Dump completed on 2026-02-09 11:28:02
