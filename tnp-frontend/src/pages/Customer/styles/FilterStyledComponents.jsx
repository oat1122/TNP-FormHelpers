...
export const StyledAccordion = styled(Accordion, {
  ...
  overflow: "hidden",
  border: expanded ? `2px solid ${filterColors.primary}` : `1px solid ${filterColors.border.light}`,
...
export const StyledAccordionSummary = styled(AccordionSummary, {
  ...
  backgroundColor: expanded ? filterColors.background.elevated : filterColors.background.paper,
  ...
  "&:hover": {
    backgroundColor: expanded ? filterColors.hover.strong : filterColors.hover.light,
  },
...
export const ExpandIconBox = styled(Box, {
  ...
  boxShadow: expanded ? filterColors.status.active.shadow : filterPanelConfig.shadows.light,
