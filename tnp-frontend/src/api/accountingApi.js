...
class AccountingAPI {
    ...
    async createQuotation(data) {
        ...
        const payload = {
            ...
            special_discount_percentage: data.specialDiscountType === 'percentage' ? data.specialDiscountValue : 0,
            special_discount_amount: data.specialDiscountType === 'amount' ? data.specialDiscountValue : data.specialDiscountAmount,
