    ...
    >
      <CardContent sx={{ p: 2.5 }}>
        ...
        <Box display="flex" alignItems="center" gap={1.5} mb={2}>
          ...
          <Box flex={1}>
            <Typography variant="subtitle2" fontWeight={700} color={hasWithholdingTax ? '#f57c00' : tokens.primary}>
              ภาษีหัก ณ ที่จ่าย
            </Typography>
        ...
        {/* Toggle Switch */}
        <Box display="flex" alignItems="center" justifyContent="space-between" mb={hasWithholdingTax ? 2 : 0}>
          <FormControlLabel
            control={
              <Switch
