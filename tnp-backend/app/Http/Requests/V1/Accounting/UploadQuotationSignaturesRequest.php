...
class UploadQuotationSignaturesRequest extends FormRequest
{
    /**
     * Determine if the user is authorized to make this request.
     *
     * Restricted to sales role (admin bypasses via Gate::before).
     */
    public function authorize(): bool
    {
        return $this->user()?->can('quotation.uploadSignatures') ?? false;
    }
