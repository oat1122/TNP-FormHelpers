...
/**
 * InvoiceCreateDialog — Phase 1 of redesign
 * - Mode-aware DialogHeader (create | edit-create)
 * - 4-tab structure: customer / items / deposit / payment
 * - Phase 1 = structural skeleton; logic kept as-is, sections will be extracted in later phases
 */
