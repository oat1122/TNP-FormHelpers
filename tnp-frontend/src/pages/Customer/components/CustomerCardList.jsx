          ...
          <Stack spacing={1}>
                ...
                {customer.cd_last_datetime && (
                  <Box
                    sx={{
                      ...
                      bgcolor:
                        recallStatus.color === "error"
                          ? "rgba(211, 47, 47, 0.1)"
                          : recallStatus.color === "warning"
                            ? "rgba(237, 108, 2, 0.1)"
                            : "rgba(46, 125, 50, 0.1)",
                      px: 1,
                      py: 0.5,
            ...
            {customer.cus_manage_by && (
              <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                ...
                >
                  ดูแลโดย:{" "}
                  {typeof customer.cus_manage_by === "object"
                    ? customer.cus_manage_by?.username ||
                      customer.cus_manage_by?.user_name ||
                      "ไม่ระบุ"
            ...
            >
              ...
              >
                ...
                {(() => {
                  try {
                    const dateValue =
                      typeof customer.cus_created_date === "object"
                        ? customer.cus_created_date?.date ||
                          customer.cus_created_date?.created_at ||
