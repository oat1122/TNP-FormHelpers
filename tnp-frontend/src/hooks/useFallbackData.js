    ...
    return [
      {
        ...
        work_calculations: {
          screen: {
            ...
            total_work: 1000,
            description:
              "Screen Printing 2 จุด เสื้อทั้งหมด 500 ตัว (2×500=1000) งาน Screen Printing มีงาน 1000",
          },
        },
      },
      {
        ...
        work_calculations: {
          dtf: {
            ...
            total_work: 900,
            description:
              "DTF (Direct Film Transfer) 3 จุด เสื้อทั้งหมด 300 ตัว (3×300=900) งาน DTF มีงาน 900",
          },
        },
      },
      {
        ...
        work_calculations: {
          sublimation: {
            ...
            total_work: 150,
            description:
              "Sublimation/Flex 1 จุด เสื้อทั้งหมด 150 ตัว (1×150=150) งาน Sublimation/Flex มีงาน 150",
          },
        },
      },
      {
        ...
        work_calculations: {
          embroidery: {
            ...
            total_work: 400,
            description:
              "Embroidery (ปัก) 2 จุด เสื้อทั้งหมด 200 ตัว (2×200=400) งาน Embroidery มีงาน 400",
          },
        },
      },
      {
        ...
        work_calculations: {
          screen: {
            ...
            total_work: 250,
            description:
              "Screen Printing 1 จุด เสื้อทั้งหมด 250 ตัว (1×250=250) งาน Screen Printing มีงาน 250",
          },
        },
      },
      {
        ...
        work_calculations: {
          dtf: {
            ...
            total_work: 360,
            description:
              "DTF (Direct Film Transfer) 2 จุด เสื้อทั้งหมด 180 ตัว (2×180=360) งาน DTF มีงาน 360",
          },
        },
      },
      {
        ...
        work_calculations: {
          sublimation: {
            ...
            total_work: 120,
            description:
              "Sublimation/Flex 1 จุด เสื้อทั้งหมด 120 ตัว (1×120=120) งาน Sublimation/Flex มีงาน 120",
          },
        },
      },
      {
        ...
        work_calculations: {
          embroidery: {
            ...
            total_work: 270,
            description:
              "Embroidery (ปัก) 3 จุด เสื้อทั้งหมด 90 ตัว (3×90=270) งาน Embroidery มีงาน 270",
          },
        },
      },
      {
        ...
        work_calculations: {
          screen: {
            ...
            total_work: 800,
            description:
              "Screen Printing 2 จุด เสื้อทั้งหมด 400 ตัว (2×400=800) งาน Screen Printing มีงาน 800",
          },
        },
      },
      {
        ...
        work_calculations: {
          dtf: {
            ...
            total_work: 440,
            description:
              "DTF (Direct Film Transfer) 2 จุด เสื้อทั้งหมด 220 ตัว (2×220=440) งาน DTF มีงาน 440",
          },
        },
      },
    ];
