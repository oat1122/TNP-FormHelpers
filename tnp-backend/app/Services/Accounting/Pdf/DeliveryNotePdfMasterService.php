...
class DeliveryNotePdfMasterService
{
    ...
    protected function renderSignatureAdaptive(Mpdf $mpdf, array $data): void
    {
        try {
            ...
            $sigHtml = View::make('pdf.partials.delivery-note-signature', $data)->render();
            ...
            // Emergency fallback
            $this->emergencySignaturePlacement($mpdf, View::make('pdf.partials.delivery-note-signature', $data)->render(), $data);
        }
    }
    ...
    protected function addHeaderFooter(Mpdf $mpdf, array $data): void
    {
        ...
        $headerHtml = View::make('pdf.partials.delivery-note-header', compact('deliveryNote', 'customer', 'isFinal'))->render();
    ...
    public function checkSystemStatus(): array
    {
        $status = [
            ...
            'views_exist'          => View::exists('accounting.pdf.delivery-note.delivery-note-master') && View::exists('pdf.partials.delivery-note-header'),
