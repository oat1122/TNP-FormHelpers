...
function CustomerSectDialog({ open, close, setValue }) {
  ...
  const { data, isLoading, error } = useGetAllCustomerQuery(queryArg);
  ...
  const handleClick = (event, id) => {
    const selectedCustomer = customerList.find((item) => item.cus_id === id);

    dispatch(
      setInputList({
        ...inputList,
        pr_cus_id: selectedCustomer.cus_id,
        ...
        cus_fullname: selectedCustomer.cus_fullname,
      })
    );
                  ...
                  visibleRows.map((row, index) => {
                    return (
                      ...
                      >
                        ...
                        <TableCell>{row.cus_fullname}</TableCell>
