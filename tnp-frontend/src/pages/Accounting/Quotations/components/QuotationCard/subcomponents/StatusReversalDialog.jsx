 ...
 * Provides a user-friendly interface for selecting reasons when reverting quotation status
 */
const StatusReversalDialog = ({ open, onClose, onSubmit, isLoading = false }) => {
  ...
  const predefinedReasons = [
    ...
    "ต้องอัพเดทข้อมูลจาก Pricing Request",
    "อื่นๆ (โปรดระบุ)",
  ];
      ...
      <DialogContent sx={{ pt: 2 }}>
        <Box display="flex" flexDirection="column" gap={2}>
          ...
          <Alert severity="info" variant="outlined" sx={{ borderRadius: 1 }}>
            การย้อนสถานะจะทำให้ใบเสนอราคากลับไปเป็น draft และสามารถแก้ไขได้อีกครั้ง
          </Alert>
