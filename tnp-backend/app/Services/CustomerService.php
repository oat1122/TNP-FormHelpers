...
class CustomerService
{
     ...
     *
     * @param  array<string, mixed>  $data  Customer data from request
     *
     * @throws \Exception
     */
     ...
     * @return array<string, string> ['old_grade' => string, 'new_grade' => string]
     *
     ...
     *
     * @param  array<int, string>  $customerIds  Array of customer UUIDs
     * @param  int  $salesUserId  User ID to assign to
     * @param  bool  $force  Force reassignment of already allocated customers
     * @return array<string, mixed> ['success_count' => int, 'failed' => array]
     *
     * @throws \Exception
     */
