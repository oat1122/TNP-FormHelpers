...
const WorkCapacityCard = ({
  ...
  if (typeof externalSelectedTimePeriod === "object" && externalSelectedTimePeriod !== null) {
    console.warn(
      "WorkCapacityCard: externalSelectedTimePeriod should be a string, not an object:",
                ...
                {process.env.NODE_ENV === "development" && (
                  <Box sx={{ mt: 2 }}>
                    ...
                    <Typography variant="caption" display="block" color="text.secondary">
                      Selected period: {String(selectedTimePeriod)} (
                      {String(getCapacityDisplayLabel(selectedTimePeriod))}){" "}
                    ...
                    <Typography variant="caption" display="block" color="text.secondary">
                      Period days:{" "}
                      {Number(calculationResult?.work_calculations?.capacity?.period_days || 1)}
                    </Typography>
                    <Typography variant="caption" display="block" color="text.secondary">
